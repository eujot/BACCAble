...
#ifdef LARGE_DISPLAY
    #define TEMP_FOUR "O$3.0f W$3.0f In$3.0f Out$3.0fC"
#else
...
const ParameterPage parameter_pages[2][64] = {
    {
        ...
        {.id = 0x2f,
         ...
         .name = "Ign cyl 5 $3.1f" "\xB0",
         .parameter_ids = {19, 19},
         .element_count = 0},
        {.id = 0x30,
         .group = 1,
         .label = "Ignition cyl 6",
         .name = "Ign cyl 6 $3.1f" "\xB0",
         .parameter_ids = {20, 20},
         .element_count = 0},
        {.id = 0x31,
         .group = 1,
